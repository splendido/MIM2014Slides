@SLIDES = [
  ...
  {layt: 'layout',  tpl: 'introduction', section: 1, path: '/introduction'},
  {layt: 'layout',  tpl: 'at1',        section: 1, path: '/at1'},
  {layt: 'layout',  tpl: 'at2',        section: 1, path: '/at2'},
  {layt: 'layout',  tpl: 'at3',        section: 1, path: '/at3'},
  {layt: 'layout',  tpl: 'at4',        section: 1, path: '/at4'},
  {layt: 'layout',  tpl: 'components', section: 2, path: '/components'},
  {layt: 'layout',  tpl: 'templates',  section: 2, path: '/templates'},
  {layt: 'layout',  tpl: 'templates2', section: 2, path: '/templates2'},
  {layt: 'layout',  tpl: 'i18n',       section: 2, path: '/18n'},
  {layt: 'layout',  tpl: 'configuration', section: 3, path: '/configuration'},
  ...
  {layt: 'layout',  tpl: 'conclusions', section: 4, path: '/conclusions'},
